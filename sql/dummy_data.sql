...
INSERT INTO club (club_id, name, teacher, description) VALUES
  ('8c6e2cde-5765-4f20-8e52-3cfcdde31b0a', '메이커스 창작부', '김지환',
   '2023년에 설립됨. 3D 프린터랑 레이저커터로 아이디어를 바로 프로토타입으로 만듦. 매주 금요일 자유 제작 시간을 열어 서로 설계 리뷰를 했음. 지역 문제 해결용 작품을 팀별로 완성함.'),
  ('b2f9b3b5-3df4-431d-943f-8b1a4a7fd3f6', '역사 탐방 연구회', '최명희',
   '2022년에 시작됨. 매달 근현대사 유적지를 답사하며 사료 분석 세미나를 진행함. 현장 사진과 기록을 전시회로 묶어 공유했음. 활동 후 토론으로 관점을 확장했음.'),
  ('f1c9d6fe-bd63-4e17-9e30-84262f59b19e', '생태 사진 동아리', '박건호',
   '2023년 봄에 결성됨. 야산과 하천 생태를 계절별로 촬영해 기록함. DSLR 기초와 라이트룸 편집을 함께 익혔음. 결과물을 교내 로비에 전시해 반응이 좋았음.'),
  ('e7d4664d-e1dc-4c18-9a8f-fb1d682dcfeb', '로봇 코딩 팀', '이하은',
   '2021년에 창립됨. 아두이노 기반 라인트레이서 로봇을 직접 제작함. 격주로 주행 알고리즘 튜닝 회의를 열었음. 하드웨어 고장도 스스로 해결하며 문제해결력을 길렀음.');
